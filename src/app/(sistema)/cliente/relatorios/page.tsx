...
export default function ReportsDashboard() {
	// Filtro global de datas: padrão início do mês atual até hoje
	...
	// Handlers de exportação direta do BFF/proxy
				...
				<>
					...
					{activeTab === "ocupacao" && occupancyData && (
						<div className="space-y-6 animate-in fade-in duration-200">
							...
							{/* Heatmap de Horários (Tabela informativa de intensidade) */}
							<Card>
								<CardHeader>
										...
										<table className="w-full text-xs text-center border-collapse">
											...
											<tbody className="divide-y divide-slate-100 font-medium text-slate-650">
												{[
													...
													// Filtra o heatmap para o dia corrente
						...
						<div className="space-y-6 animate-in fade-in duration-200">
							...
							<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
								...
								<Card className="bg-slate-50/50">
									<CardContent className="p-4">
										<span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block">Taxa de Retorno</span>
										<span className="text-2xl font-black text-slate-800 mt-1 block">{customerData.return_rate.toFixed(1)}%</span>
									</CardContent>
								</Card>
							</div>
